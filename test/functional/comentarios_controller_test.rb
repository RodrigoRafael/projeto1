...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type, conteudo: @comentario.conteudo, text: @comentario.text }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { comentavel_id: @comentario.comentavel_id, comentavel_type: @comentario.comentavel_type, conteudo: @comentario.conteudo, text: @comentario.text }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
